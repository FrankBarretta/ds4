...
CORE_OBJS = ds4.o ds4_distributed.o ds4_ssd.o ds4_expert_trace.o ds4_metal.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_ssd.o ds4_expert_trace.o
else
...
CORE_OBJS = ds4.o ds4_distributed.o ds4_ssd.o ds4_expert_trace.o ds4_cuda.o
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_ssd.o ds4_expert_trace.o
...
strix-halo:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-eval ds4-agent \
		CORE_OBJS="ds4.o ds4_distributed.o ds4_ssd.o ds4_expert_trace.o ds4_rocm.o" \
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_expert_trace.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c

ds4_ssd.o: ds4_ssd.c ds4_ssd.h
	$(CC) $(CFLAGS) -c -o $@ ds4_ssd.c

ds4_expert_trace.o: ds4_expert_trace.c ds4_expert_trace.h
	$(CC) $(CFLAGS) -c -o $@ ds4_expert_trace.c
...
ds4_cpu.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_expert_trace.h
